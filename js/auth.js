/* Silent Speak - Authentication Module */
 
// Authentication class using OOP principles
class AuthSystem {
    constructor() {
...
function safeToast(message, type = 'info') {
    // Try to use SilentSpeak.showToast if available
    if (window.SilentSpeak && typeof window.SilentSpeak.showToast === 'function') {
        window.SilentSpeak.showToast(message, type);
        return;
    }
...
function handleLoginForm(formId) {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (result.success) {
            ...
            safeToast(result.message, 'danger');
        }
    });
}
...
function handleRegisterForm(formId) {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (password !== confirmPassword) {
            safeToast('Passwords do not match', 'danger');
            return;
        }
